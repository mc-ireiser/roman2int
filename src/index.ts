 ...
 */
function roman2int(value: string) {
 ...
 */
function response(isValidRomanNum: boolean, value: string) {
 ...
 */
function calculateInteger(romeNum: string) {
  let result: number = 0;

  romeNum.replace(/[MDLV]|C[MD]?|X[CL]?|I[XV]?/g, function (item: string) {
